                    ...
                    {[...Array(8)].map((_, col) => (
                        <div key={col}>
                            <input
                                ...
                                className="border-5 h-6 w-6 appearance-none rounded-full border border-white transition-all duration-100 ease-in-out checked:border-transparent checked:bg-white"
        ...
        <div className="flex flex-col space-y-5">
            <div className="flex flex-row justify-end">
                <div className="-mr-2.5">
                    {columns.map((col) => (
                        <span
                            key={col}
                            className="space-x-tip-col relative rounded-full bg-blue-900 px-3 py-1 text-center text-gray-900 dark:text-white"
                        >
                            {col}
                        </span>
                    ))}
            ...
            <div className="flex flex-row items-center justify-center space-x-4">
                <div className="space-y-1.5">
                    {rows.map((row) => (
                        <div key={row}>
                            <p className="w-fit rounded-full bg-blue-900 px-3 py-1 text-center text-gray-600 dark:text-white">
                                {row}
                            </p>
                        </div>
                    ))}
                ...
                {/* Pass onStartChange to TipModule */}
                <TipModule />
            </div>
        </div>
    );
